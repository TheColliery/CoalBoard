---
description: CoalBoard self-update — check for a newer version and offer to apply it, or set how updates are handled.
---
...
This is orthogonal to the board (its own off-switch) and never auto-applies — it offers, the user runs the update.
