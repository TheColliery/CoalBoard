...
- **Ratchet, after the self-fence removal (SUPERSEDES the line above as the baseline the next release diffs against):** body 44,073 → **43,362 ch (LF-normalized)**, −711 · `references/opinion-board.md` 10,924 → **10,854** · `references/audit.md` 7,314 → **6,967**. A removal, not a carve — no explanation prose moved to a reference, so nothing offsets it.
